# run.ps1
# Compiles and runs the FactoryMethodPatternExample project independently.

$ErrorActionPreference = "Stop"
$projectName = "FactoryMethodPatternExample"
$testClass = "com.pattern.factory.FactoryMethodTest"
